...
const REMOVE_FAVORITE = '[FAVORITE] Remove';
let AddFavorite = class AddFavorite {
    constructor(payload) {
        this.payload = payload;
        this.type = ADD_FAVORITE;
    }
};
AddFavorite.ctorParameters = () => [
...
let FavoritesComponent = class FavoritesComponent {
    constructor(forecastForFavorite, store, router, snack) {
...
let WeatherForecastComponent = class WeatherForecastComponent {
    constructor(forecast, citySearchService, store, snack, titleService) {
...
class City {
    constructor(Version, Key, Type, Rank, LocalizedName, Country, AdministrativeArea) {
...
let CitySearchService = class CitySearchService {
...
CitySearchService.ctorParameters = () => [
